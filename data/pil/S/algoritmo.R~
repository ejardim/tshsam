######################################################################
# South component of the Iberian sardine stock
# Note1: Survey was stable, no support for yearly changes.
######################################################################
...
S.q2mc <- a4aSCA(S.stk, S.idx, fmodel=fmod, qmodel=qmod, fit="MCMC", mcmc=SCAMCMC(mcmc=12500, mcsave=250, mcprobe = 0.4))
...
S.q3mc <- a4aSCA(S.stk, S.idx2, fmodel=fmod, qmodel=qmod, fit="MCMC", mcmc=SCAMCMC(mcmc=12500, mcsave=250, mcprobe = 0.4))
...
S.q4mc <- a4aSCA(S.stk, S.idx2, fmodel=fmod, qmodel=qmod, fit="MCMC", mcmc=SCAMCMC(mcmc=12500, mcsave=250, mcprobe = 0.4))
...
plot(S.q5f, S.stk)
plot(S.q5f, S.idx[1])
wireframe(data~age + year, data=harvest(S.q5f))
S.q5s <- S.stk + simulate(S.q5f, 500)
S.q5mc <- a4aSCA(S.stk, S.idx[1], fmodel=fmod, qmodel=qmod, fit="MCMC", mcmc=SCAMCMC(mcmc=12500, mcsave=250, mcprobe = 0.4))
S.q5mcmc <- as.mcmc(S.q5mc)
levelplot(abs(cor(S.q5mcmc)))
